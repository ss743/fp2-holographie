...
%Hinter dem Laser befindet sich ein elektrooptischer Modulator. Das polarisierte Licht wird in diesem
%spannungsabhängig gedreht und tritt anschließend durch einen Polarisationsfilter wieder aus. So kann
%die Intensität des Strahls beeinflusst werden, indem die Spannung z.B. so eingestellt wird, dass das
%Licht im Modulator gerade in die gleiche Richtung gedreht wird, wie der Polarisator steht. Dann kann
%das gesamte Laserlicht den Polarisator passieren. Dreht der Modulator das Licht im 90-Winkel zum
%Polarisator, kommt kein Licht hindurch.
