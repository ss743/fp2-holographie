...
\begin{frame}
	\frametitle{Convolution Theorem}
	\gra[0.65]{Convolution}{Illustration of the Convolution theorem with the example of the double slit\footnotemark}\footnotetext{http://www4.uwsp.edu/physastr/kmenning/images/Hecht4.11.F.31.png}
\end{frame}
\begin{frame}
...
\begin{frame}
	\frametitle{Cross- and Autocorrelation}
	\gra[0.65]{correlation}{Visual comparison of convolution, cross-correlation and autocorrelation  \footnotemark} \footnotetext{By Cmglee - Own work, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=20206883}
\end{frame}
\begin{frame}
