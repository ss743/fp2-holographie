	...
	\begin{columns}
		...
		\begin{column}{0.5\textwidth}
			\begin{itemize}
                ...
                \item Measured values and Literature values not compatible regarding their errors
           \item  check for statistical and systematical errors
           \item $\Rightarrow$ Linear Fit between measured and literature values
          \item $\Rightarrow$ Comparison with $x_{m\nu}^2$ values
          \end{itemize}
		\end{column}
	\end{columns}
	...
	\begin{columns}
		...
		\begin{column}{0.45\textwidth}
			\begin{figure}[h]
				...
				\begin{overpic}[width=0.33\textwidth,tics=10]
					{../figures/fourier-90-2-edit.png}
					\put(10,80){\textcolor{white}{$\alpha=90\degree$}}
				\end{overpic}
			\end{figure}
