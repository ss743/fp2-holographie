...
\begin{frame}
	...
	\graTwoOneB[0.2]{obj1}{obj1b}{Blackness of a photo plate for an\newline object point (spherical wave) \footfullcite{staats}}&
	\gra[0.5]{Reconstruction1}{Reconstruction of the Hologram \footnotemark}
	\end{tabular}
	...
	\begin{table}
		...
		\begin{tabular}{p{5cm}p{5cm}}
			...
			&
				...
				\gra[0.6]{Coherence}{Temporal coherence of wavelets \footnotemark}{\footnotetext{https://i.stack.imgur.com/U9JsT.png}}
